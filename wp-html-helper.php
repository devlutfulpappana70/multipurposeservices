...
// image default alt
if( !function_exists( 'rakar_img_default_alt' ) ){
	function rakar_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'rakar_img_tag' ) ){
	function rakar_img_tag( array $args ){
...
// Anchor Tag
if( !function_exists( 'rakar_anchor_tag' ) ){
	function rakar_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'rakar_heading_tag' ) ){
	function rakar_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'rakar_paragraph_tag' ) ){
	function rakar_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'rakar_span_tag' ) ){
	function rakar_span_tag( array $args ){
