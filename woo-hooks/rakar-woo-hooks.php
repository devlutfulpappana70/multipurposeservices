...
add_filter( 'loop_shop_per_page', 'rakar_new_loop_shop_per_page', 20 );

function rakar_new_loop_shop_per_page( $product_count ) {

    if( class_exists('ReduxFramework') ) { 

        $product_count = rakar_opt( 'rakar_woo_product_perpage' );
...
add_filter('woocommerce_product_loop_start','rakar_woocommerce_product_loop_start');

function rakar_woocommerce_product_loop_start( ) {
...
add_filter('woocommerce_product_loop_end','rakar_woocommerce_product_loop_end');

function rakar_woocommerce_product_loop_end( ) {
...
add_filter('woocommerce_format_sale_price','rakar_woocommerce_format_sale_price',10,3);

function rakar_woocommerce_format_sale_price( $price, $regular_price, $sale_price ) {
...
add_filter('woocommerce_review_gravatar_size','rakar_woocommerce_review_gravatar_size');

function rakar_woocommerce_review_gravatar_size() {
...
add_filter('woocommerce_output_related_products_args','rakar_woocommerce_output_related_products_args',10,1);

function rakar_woocommerce_output_related_products_args( $args ) {

    if( class_exists('ReduxFramework') ) {

        $args['posts_per_page'] = rakar_opt('rakar_woo_relproduct_num');
...
add_filter('woocommerce_upsell_display_args','rakar_woocommerce_upsell_display_args',10,1);

function rakar_woocommerce_upsell_display_args( $args ) {

    if( class_exists('ReduxFramework') ) {

        $args['posts_per_page'] = rakar_opt('rakar_woo_upsellproduct_num');
...
function woocommerce_cross_sells_total( $limit ) {
    ...
    if( class_exists('ReduxFramework') ) {
        ...
        $limit = rakar_opt('rakar_woo_crosssellproduct_num');
...
add_filter( 'woocommerce_add_to_cart_fragments', 'rakar_refresh_mini_cart_count');

function rakar_refresh_mini_cart_count($fragments){
...
add_filter( 'woocommerce_checkout_fields' , 'rakar_override_checkout_fields' );

function rakar_override_checkout_fields( $fields  ){
    ...
    $fields['billing']['billing_first_name']['placeholder'] = esc_attr__('First Name', 'rakar');
    ...
    $fields['billing']['billing_last_name']['placeholder'] = esc_attr__('Last Name', 'rakar');
    ...
    $fields['billing']['billing_company']['placeholder'] = esc_attr__('Company name (optional)', 'rakar');
    ...
    $fields['billing']['billing_phone']['placeholder'] = esc_attr__('Phone', 'rakar');
    ...
    $fields['billing']['billing_email']['placeholder'] = esc_attr__('Email address', 'rakar');
    ...
    $fields['billing']['billing_city']['placeholder'] = esc_attr__('Town / City', 'rakar');
    ...
    $fields['billing']['billing_postcode']['placeholder'] = esc_attr__('Postcode', 'rakar');
    ...
    $fields['shipping']['shipping_first_name']['placeholder'] = esc_attr__('First Name', 'rakar');
    ...
    $fields['shipping']['shipping_last_name']['placeholder'] = esc_attr__('Last Name', 'rakar');
    ...
    $fields['shipping']['shipping_company']['placeholder'] = esc_attr__('Company name (optional)', 'rakar');
    ...
    $fields['shipping']['shipping_phone']['placeholder'] = esc_attr__('Phone', 'rakar');
    ...
    $fields['shipping']['shipping_email']['placeholder'] = esc_attr__('Email address', 'rakar');
    ...
    $fields['shipping']['shipping_city']['placeholder'] = esc_attr__('Town / City', 'rakar');
    ...
    $fields['shipping']['shipping_postcode']['placeholder'] = esc_attr__('Postcode', 'rakar');
...
add_filter( 'woocommerce_default_address_fields', 'rakar_override_default_locale_fields' );

function rakar_override_default_locale_fields( $fields ) {
...
add_filter( 'woocommerce_billing_fields' , 'rakar_custom_billing_fields' );

function rakar_custom_billing_fields( $fields ) {
    ...
    $fields['billing_first_name']['placeholder'] = esc_attr__('First Name', 'rakar');
    ...
    $fields['billing_last_name']['placeholder'] = esc_attr__('Last Name', 'rakar');
    ...
    $fields['billing_company']['placeholder'] = esc_attr__('Company name (optional)', 'rakar');
    ...
    $fields['billing_phone']['placeholder'] = esc_attr__('Phone', 'rakar');
    ...
    $fields['billing_email']['placeholder'] = esc_attr__('Email address', 'rakar');
    ...
    $fields['billing_city']['placeholder'] = esc_attr__('Town / City', 'rakar');
    ...
    $fields['billing_postcode']['placeholder'] = esc_attr__('Postcode', 'rakar');
...
add_filter( 'woocommerce_shipping_fields' , 'rakar_custom_shipping_fields' );

function rakar_custom_shipping_fields( $fields ) {
    ...
    $fields['shipping_first_name']['placeholder'] = esc_attr__('First Name', 'rakar');
    ...
    $fields['shipping_last_name']['placeholder'] = esc_attr__('Last Name', 'rakar');
    ...
    $fields['shipping_company']['placeholder'] = esc_attr__('Company name (optional)', 'rakar');
    ...
    $fields['shipping_phone']['placeholder'] = esc_attr__('Phone', 'rakar');
    ...
    $fields['shipping_email']['placeholder'] = esc_attr__('Email address', 'rakar');
    ...
    $fields['shipping_city']['placeholder'] = esc_attr__('Town / City', 'rakar');
    ...
    $fields['shipping_postcode']['placeholder'] = esc_attr__('Postcode', 'rakar');
...
add_action('woocommerce_before_main_content','rakar_shop_col_start_cb');



// Shop column end wrapper hook

add_action('woocommerce_after_main_content','rakar_shop_col_end_cb',10);



// shop main content hook

add_action('rakar_shop_main_content','rakar_shop_main_content_cb',10);



// shop main content end hook

add_action('rakar_shop_main_content_end','rakar_shop_main_content_end_cb',10);



// rakar woocommerce pagination hook

add_action('woocommerce_after_shop_loop','rakar_woocommerce_pagination',10);



// rakar woocommerce filter wrapper hook

add_action('woocommerce_before_shop_loop','rakar_woocommerce_filter_wrapper',20);



// rakar woocommerce product content wrapper

add_action('rakar_woocommerce_product_content', 'rakar_woocommerce_tab_content_wrapper_start', 10 );

add_action('rakar_woocommerce_product_content', 'rakar_grid_tab_content_cb', 10 );

add_action('rakar_woocommerce_product_content', 'rakar_list_tab_content_cb', 20 );

add_action('rakar_woocommerce_product_content', 'rakar_woocommerce_tab_content_wrapper_end', 30 );



// rakar woocommerce get sidebar

add_action('woocommerce_sidebar','rakar_woocommerce_get_sidebar',10);
...
// rakar shop loop product thumbnail hook

add_action( 'woocommerce_before_shop_loop_item', 'rakar_loop_product_thumbnail', 10 );



// rakar shop loop hozrizontal product thumbnail hook

add_action( 'woocommerce_before_shop_horizontal_loop_item', 'rakar_loop_horiontal_product_thumbnail', 10 );



// rakar shop loop horizontal product summary hook

add_action('rakar_woocommerce_shop_three_loop_product_summary','rakar_woocommerce_shop_three_loop_product_summary_cb',10);
...
add_action('woocommerce_before_single_product_summary', 'rakar_woocommerce_before_single_product_summary',10);



// single product title

add_action('woocommerce_single_product_summary', 'rakar_woocommerce_single_product_title', 30 );



// single product price and rating

add_action('woocommerce_single_product_summary', 'rakar_woocommerce_single_product_price_rating', 20 );



// single product excerpt

add_action('woocommerce_single_product_summary', 'rakar_woocommerce_single_product_excerpt', 40 );



// single product availability

add_action( 'woocommerce_single_product_summary', 'rakar_woocommerce_single_product_availability', 50 );



// single product add to cart button

add_action('woocommerce_single_product_summary','rakar_woocommerce_single_add_to_cart_button',60);



// single product meta hook

add_action('woocommerce_single_product_summary','rakar_woocommerce_single_meta',80);



// single product sidebar

add_action('rakar_woocommerce_single_product_sidebar','rakar_woocommerce_single_product_sidebar_cb');
...
add_action('rakar_quickview_before_single_product_summary','rakar_woocommerce_before_single_product_summary',10);



// single product price and rating

add_action('rakar_quickview_single_product_summary','rakar_woocommerce_single_product_price_rating',20);



// single product title

add_action('rakar_quickview_single_product_summary','rakar_woocommerce_quickview_single_product_title',30);



// single product excerpt

add_action('rakar_quickview_single_product_summary','rakar_woocommerce_single_product_excerpt',40);



// single product add to cart button

add_action('rakar_quickview_single_product_summary','rakar_woocommerce_single_add_to_cart_button',60);
...
add_action('woocommerce_review_before_comment_meta','rakar_woocommerce_reviewer_meta',10,1);
...
add_action('woocommerce_proceed_to_checkout','rakar_woocommerce_button_proceed_to_checkout',20);



// cross sell products

add_action('woocommerce_after_cart','rakar_woocommerce_cross_sell_display',10);



// mini cart view cart button

add_action('woocommerce_widget_shopping_cart_buttons','rakar_minicart_view_cart_button',10);



// mini cart checkout button

add_action('woocommerce_widget_shopping_cart_buttons','rakar_minicart_checkout_button',20);
...
// rakar woocommerce checkout login form

add_action('woocommerce_before_checkout_form','rakar_woocommerce_before_checkout_form',10);
...
add_filter( 'wooscp_button_html', 'rakar_wooscp_button_html', 10, 2 );

function rakar_wooscp_button_html( $output , $prodid ) {
...
add_filter( 'wooscp_button_text_added', 'rakar_woo_compare_btn_text_added', 10, 2 );

function rakar_woo_compare_btn_text_added( ){
...
add_filter( 'wooscp_button_text', 'rakar_compare_btn_text', 10, 2 );

function rakar_compare_btn_text(){
...
add_filter( 'woosq_button_html', 'rakar_woosq_button_html', 10, 2 );

function rakar_woosq_button_html( $output , $prodid ) {
