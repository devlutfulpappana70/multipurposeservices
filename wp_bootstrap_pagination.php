...
function rakar_pagination( $args = array() ) {
    ...
    $defaults = array(
        'range'           => 4,
        'custom_query'    => FALSE,
        'previous_string' => esc_html__( '&laquo;', 'rakar' ),
        'next_string'     => esc_html__( '&raquo;', 'rakar' ),
        'before_output'   => '',
        'after_output'    => ''
    );
    ...
    $args = wp_parse_args( 
        $args, 
        apply_filters( 'rakar_pagination_defaults', $defaults )
    );
