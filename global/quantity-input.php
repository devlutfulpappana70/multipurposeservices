...
if ( $max_value && $min_value === $max_value ) {
    ...
    $label = ! empty( $args['product_name'] ) ? sprintf( esc_html__( '%s quantity', 'rakar' ), wp_strip_all_tags( $args['product_name'] ) ) : esc_html__( 'Quantity', 'rakar' );
    ?>
        ...
        <label class="screen-reader-text" for="<?php echo esc_attr( $input_id ); ?>"><?php echo esc_html( $label ); ?></label>
            ...
            <input
                ...
                title="<?php echo esc_attr_x( 'Qty', 'Product quantity input tooltip', 'rakar' ); ?>"
                size="4"
