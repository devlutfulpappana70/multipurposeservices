...
<section class="woocommerce-customer-details">
    <section class="woocommerce-columns woocommerce-columns--2 woocommerce-columns--addresses col2-set addresses row">
        ...
        <?php endif; ?>
            <h2 class="woocommerce-column__title"><?php esc_html_e( 'Billing address', 'rakar' ); ?></h2>
            <address>
                <?php echo wp_kses( $order->get_formatted_billing_address( esc_html__( 'N/A', 'rakar' ) ), $allowhtml ); ?>
	...
	<?php if ( $show_shipping ) : ?>
		...
		<div class="woocommerce-column woocommerce-column--2 woocommerce-column--shipping-address col-sm-6">
			<h2 class="woocommerce-column__title"><?php esc_html_e( 'Shipping address', 'rakar' ); ?></h2>
			<address>
				<?php echo wp_kses( $order->get_formatted_shipping_address( esc_html__( 'N/A', 'rakar' ) ), $allowhtml ); ?>
			</address>
		</div><!-- /.col-2 -->
