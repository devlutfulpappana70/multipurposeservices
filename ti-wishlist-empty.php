...
<div class="tinv-wishlist woocommerce">
	...
	<p class="cart-empty woocommerce-info">
		<?php if (get_current_user_id() === $wishlist['author']) { ?>
			<?php esc_html_e('Your Wishlist is currently empty.', 'rakar'); ?>
		<?php } else { ?>
			<?php esc_html_e('Wishlist is currently empty.', 'rakar'); ?>
		<?php } ?>
	</p>
	...
	<p class="return-to-shop">
		<a class="th-btn wc-backward"
		   href="<?php echo esc_url(apply_filters('woocommerce_return_to_shop_redirect', wc_get_page_permalink('shop'))); ?>"><?php echo esc_html(apply_filters('woocommerce_return_to_shop_text', __('Return To Shop', 'rakar'))); ?></a>
	</p>
</div>
